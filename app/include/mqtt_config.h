...
/***********************************************************************************************************************/
#define CFG_HOLDER    0x00FF6666    /* Change this value to load default configurations */

/*DEFAULT CONFIGURATIONS*/
//nYMy5B+5uNUdjp8EnP218fgodhKE2foEwEy+Accf62k=
#define MQTT_HOST            "183.230.40.39" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            6002    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID       "xxxxxxxxx"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER            "xxxxxx" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "xxxxxxxxxxxx" // you MQTT login password, same as above
#define STA_SSID 			 "xxxxxxx"    // your AP/router SSID to config your device networking
#define STA_PASS 			 "xxxxxxxx" // your AP/router password
